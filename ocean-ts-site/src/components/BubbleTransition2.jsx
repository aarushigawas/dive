...
const BubbleTransition2 = ({ onComplete }) => {
  ...
  const [phase, setPhase] = useState(0); // 0: preparing, 1: descending, 2: complete
  ...
  // Generate spiral bubble pattern
  ...
  return (
    <div className={`bubble-transition2-container ${isAnimating ? 'animating' : ''} phase-${phase}`}>
      {/* Animated background with depth layers */}
